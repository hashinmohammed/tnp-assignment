...
const Electricpowertrain = ({
  ...
  const Powertrain = [{ url: url1 }, { url: url2 }];
    ...
    <div className="bg-[#f4f4f4] pt-14 py-10">
      ...
      <div>
        ...
        <div className="flex justify-center max-w-[90vw] mx-auto">
          ...
          >
            {currentIndex === true && (
              <div className=" absolute top-0 right-0 left-0 bottom-0 bg-white/60 border-t-2 border-white/60" />
            )}
            ...
            <div className="flex justify-center items-center text-center mt-4 flex-col sm:flex-row sm:justify-start">
              <div className="mb-3 mr-4 md:mr-10">
                <h1 className="font-bold text-2sm lg:text-2xl">
                  {epstatheading11}
                </h1>
