  ...
  return (
    <div className="overflow-y-auto bg-tesla-dark h-screen animate-pulse">
      ...
      <div className="relative h-screen w-full bg-gray-900 flex flex-col justify-end pb-10 md:pb-20 items-center">
        {/* Title Positioned Centered styled like actual banner */}
      ...
      {/* Beyond Sections (x2) */}
      {[1, 2].map((i) => (
        <div key={i} className="max-w-[1000px] mx-auto my-12 px-4">
          <div className="flex flex-col md:flex-row mb-5">
            <div className="md:w-1/3 mb-4 md:mb-0 md:mr-24">
          ...
          {/* Order Button */}
          <div className="h-10 w-[220px] bg-gray-800 rounded mt-4"></div>
        </div>
      ))}
    </div>
  );
...
export default SkeletonCybertruck;
