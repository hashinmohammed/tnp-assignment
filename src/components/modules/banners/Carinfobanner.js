    ...
    <div className="relative lg:h-auto overflow-hidden">
      ...
      >
        <div className="flex items-center overflow-hidden justify-center mr-12 sm:mr-0">
          ...
          >
            <h2 className="text-xs overflow-hidden font-bold text-center mb-1 sm:text-xl lg:text-2xl">
              {infoheading1}
            </h2>
            <p className="text-center text-[6px] sm:text-[10px] md:text-[8px] lg:text-xs">
              {infodescription1}
            </p>
          </motion.div>
          <motion.div
